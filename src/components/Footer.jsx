...
const Footer = () => {
  return (
    ...
    <div className='border-4 w-370 relative top-4 left-5 bg-black h-120 text-amber-50 rounded-2xl'>
      ...
      <div className=' w-70 relative left-280'>
      <span><a href="https://www.linkedin.com/in/umendrapratapsingh/" ><img className='rounded-full hover:scale-110 h-12 relative  top-11.5' src="images/linkedin.png"  /></a></span>
       <span><a href="https://github.com/umendra-1999"><img className='rounded-full hover:scale-110 h-11 relative left-20' src="images/github.png"  /></a></span>
      </div>
